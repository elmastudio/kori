...
return array(
	...
	<div class="wp-block-group header-content"><!-- wp:site-title {"style":{"spacing":{"padding":{"top":"2rem"}}},"fontSize":"text-xxl"} /-->
	
	<!-- wp:ainoblocks/flexbox {"justifyContentDesktop":"justify__flexend__d","justifyContentTablet":"justify__flexend__t","justifyContentMobile":"justify__flexend__m","position":"pos-none","className":"nav-float","borderRadius":"rounded-full","paddingTop":0,"paddingBottom":0,"paddingLeft":0,"paddingRight":0} -->
